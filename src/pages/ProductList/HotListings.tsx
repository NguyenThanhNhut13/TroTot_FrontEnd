    ...
    const fetchRooms = async () => {
      try {
        ...
        const mapped: Listing[] = rooms.map((room: Room) => ({
          image: room.imageUrls[0] || "https://tromoi.com/uploads/guest/o_1h5tpk1fl1i0047413epqpsee3a.jpg",
          title: room.title,
                  ...
                  {listing ? (
                    <Card className="h-100 border-0 shadow-sm position-relative">
                      ...
                      <div 
                        ...
                        style={{ top: '10px', left: '0', zIndex: 1, fontSize: '0.7rem' }}
                      >
                        HOT
                      </div>
                      ...
                      <div 
                        ...
                        style={{ top: '10px', right: '10px', width: '28px', height: '28px', zIndex: 1, cursor: 'pointer' }}
                      >
                      ...
                      <Card.Body className="p-3">
                        ...
                        <div className="d-flex justify-content-between align-items-center mb-2">
                          <div className="text-danger fw-bold" style={{ fontSize: '1.1rem' }}>
                            {parseFloat(listing.price.replace(/[^\d.]/g, '')).toLocaleString()} triệu/tháng
                          </div>
                        ...
                        <div className="d-flex align-items-center text-muted" style={{ fontSize: '0.85rem' }}>
                          ...
                          <div className="text-truncate">{listing.location}</div>
                        </div>
                      </Card.Body>
                    </Card>
                  ) : (
